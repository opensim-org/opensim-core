...
cmake ..\muscollo `
    ...
    -DCMAKE_PREFIX_PATH="$pwd\..\muscollo_dependencies_install\ipopt;$pwd\..\muscollo_dependencies_install\eigen;$pwd\..\muscollo_dependencies_install\opensim-core;$pwd\..\muscollo_dependencies_install\colpack"
cmake --build . --config RelWithDebInfo -- /maxcpucount:8
