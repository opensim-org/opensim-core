...
TEST_CASE("testLiveIK") {
    // The following model contain a Thelen2003Muscle that should be registered
    // when the osimActuators library is loaded. But unless we call at least one
