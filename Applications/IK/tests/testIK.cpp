...
TEST_CASE("testInverseKinematicsGait2354") {
...
TEST_CASE("testInverseKinematicsConstraintTest") {
    InverseKinematicsTool ik3("constraintTest_setup_ik.xml");
    ik3.run();
}

TEST_CASE("testInverseKinematicsScapulothoracicAbduction") {
...
TEST_CASE("testInverseKinematicsSolverWithOrientations") {
...
TEST_CASE("testInverseKinematicsSolverWithEulerAnglesFromFile") {
    Model model("subject01_simbody.osim");
    auto orientationsData = convertMotionFileToRotations(
        model, "std_subject01_walk1_ik.mot");
