...
void scaleGait2354()
{
    ...
    */
    ...
    // We used to compute a scale factor the ground body, which does not make phyisical sense.
    // Things connected to ground can be scaled, including their locations.
