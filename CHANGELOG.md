...
- Replace all instances of `<min_control> 0.00000000 </min_control>` with `<min_control> 0.01000000 </min_control>` that occur in the default blocks which cause the `min_control` error (#3986).
