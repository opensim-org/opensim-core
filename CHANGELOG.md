...
- The Matlab utility osimTableToStruct() now handles column labels that start with a non-letter character by removing the non-letter character (as opposed to prepending "unlabeled").
