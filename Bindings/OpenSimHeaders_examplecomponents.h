#ifndef OPENSIM_OPENSIM_HEADERS_EXAMPLECOMPONENTS_H_
#define OPENSIM_OPENSIM_HEADERS_EXAMPLECOMPONENTS_H_
...
#endif // OPENSIM_OPENSIM_HEADERS_EXAMPLECOMPONENTS_H_
