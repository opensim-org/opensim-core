...
class TestTables {
    public static void test_DataTable() {
        ...
        table.setColumnLabels(labels);
        DataTableVec4 tableVec4 = table.packVec4();
        assert tableVec4.getColumnLabel(0).equals("col0");
        assert tableVec4.getColumnLabel(1).equals("col1");
        assert tableVec4.getColumnLabel(2).equals("col2");
        assert tableVec4.getNumRows()    == 3;
        assert tableVec4.getNumColumns() == 3;
        System.out.println(tableVec4);
        tableFlat = tableVec4.flatten();
        assert tableFlat.getColumnLabels().size() == 12;
        assert tableFlat.getColumnLabel( 0).equals("col0_1");
    ...
    public static void test_TimeSeriesTable() {
        ...
        labels.add("col2.1"); labels.add("col2.2"); labels.add("col2.3");
        table.setColumnLabels(labels);
        TimeSeriesTableVec4 tableVec4 = table.packVec4();
        assert tableVec4.getColumnLabel(0).equals("col0");
        assert tableVec4.getColumnLabel(1).equals("col1");
        assert tableVec4.getColumnLabel(2).equals("col2");
        assert tableVec4.getNumRows()    == 3;
