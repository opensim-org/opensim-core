...
class TestSockets(unittest.TestCase):
    ...
    def test_iterate_sockets(self):
        ...
        for i in range(shoulder.getNumSockets()):
            count_by_index += 1
            assert shoulder.getSocket(i).getName() == names[i]
    ...
    def test_connecting(self):
        ...
        j1.updSocket("child_frame").connect(b1)

        j2 = osim.PinJoint()
        j2.setName("j2")
        j2.updSocket("parent_frame").connect(b1)
