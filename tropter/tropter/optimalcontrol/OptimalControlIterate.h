...
/// <#>,<#>,...,<#>,...
// TODO: incorporating parameters in file format (using metadata?)
/// @endverbatim
...
struct OptimalControlIterate {
    ...
    /// (i.e. states and controls) within this iterate to produce a iterate with 
    /// a desired number of columns with equally spaced time points. This is 
    /// useful when forming an initial guess for an optimal control problem. If
    /// the size of time matches desired_num_columns, then we return a copy of 
    /// this iterate (no interpolation).
