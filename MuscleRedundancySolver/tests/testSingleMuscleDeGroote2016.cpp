...
/// TODO put DeGroote's muscle in some common code somewhere.
template <typename T>
...
private:
    double m_max_isometric_force;
    double m_optimal_fiber_length;
    double m_tendon_slack_length;
    double m_pennation_angle_at_optimal;
    double m_max_contraction_velocity;
    double m_fiber_width;
};
