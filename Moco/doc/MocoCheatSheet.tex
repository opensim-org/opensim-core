...
\vspace{-15pt}
    \begin{align*}
        ...
        \mbox{subject to}
         ...
         & V_{L,k} \leq V_{k}\displaystyle\left(t_0,t_f,y_0, y_f, x_0, x_f, \lambda_0, \lambda_f, p, \int_{t_0}^{t_f} s_{e,k}(t,y,x,\lambda,p)~dt\displaystyle\right) \leq V_{U,k} && \texttt{problem.addGoal()} \\
...
\item $ w_j $: weight for $ j $-th goal
\item $ J_{j} $: the $ j $-th goal
\item $ s_{c,j} $: integrand used in the $ j $-th goal
\item $ M $: mass matrix
