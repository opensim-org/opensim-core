...
\vspace{-15pt}
    \begin{alignat*}{2}
        \mbox{minimize}
         \quad & \sum_j w_{j} J_{j}(t_0, t_f, y_0, y_f, x_{0}, x_{f}, \lambda_0, \lambda_f, p, S_{c,j}) \quad\quad
        ...
        \mbox{subject to}
         ...
         & y_{0,L} \leq y_0 \leq y_{0,U} \quad\quad y_{f,L} \leq y_f \leq y_{f,U} \\
         & x_{0,L} \leq x_0 \leq x_{0,U} \quad\quad x_{f,L} \leq x_f \leq x_{f,U} \\
         \mbox{with respect to} \quad
         & y \in [y_{L}, y_{U}] \quad\quad  t_0 \in [t_{0,L}, t_{0,U}] \\
         & x \in [x_{L}, x_{U}] \quad\quad  t_f \in [t_{f,L}, t_{f,U}] \\
         & p \in [p_{L}, p_{U}] \\
    \end{alignat*}
%};
%\end{tikzpicture}
