...
\begin{center}
    ...
    $ y(t) $     & $ (q(t),u(t),z(t)) $                                 & $ f_{\textrm{bias}} $ & centripetal and coriolis forces         & $ K $                        & number of endpoint constraints \\
    $ x(t) $     & controls                                             & $ G $                 & kinematic constraint Jacobian           & $ (\hspace{1em})_{U}   $     & an upper bound \\
    $ p    $     & constant parameters                                  & $ f_{\textrm{app}} $  & applied forces                          & $ (\hspace{1em})_{L}   $     & a lower bound \\
    $ \lambda $  & kinematic constraint multipliers                     & $ f_{\textrm{aux}} $  & auxiliary (muscle) dynamics             & $  $            & \\
\end{tabular}
\end{center}
