// DecompHardUTWalkNoCompPrescribed.cpp
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//	AUTHOR: Frank C. Anderson, Saryn R. Goldberg
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
/* 
 * This routine is different from DecompHardUTWalk in that it does not apply 
 ...
 * This routine is different from DecompHardUTWalkNoComp in that the constructor 
 ...
 * Destructor.
 */
DecompHardUTWalkNoCompPrescribed::~DecompHardUTWalkNoCompPrescribed()
{
 ...
 */
DecompHardUTWalkNoCompPrescribed::DecompHardUTWalkNoCompPrescribed(rdUTWalking8Prescribed *aModel, 
	Storage *aPrescribedSpringForceStorage, bool aModelIsSagittalR, bool aModelIsSagittalL) : DecompNoComp(aModel)
{
	setNull();
 ...
 */
void DecompHardUTWalkNoCompPrescribed::
setNull()
{
	_c = 0;
	_nxs = 0;
 ...
 * invalid.
 */
double* DecompHardUTWalkNoCompPrescribed::
 ...
 */
Storage* DecompHardUTWalkNoCompPrescribed::
		  ...
		  double *xt,double *y)
{
	...
	DecompTargetNoCompPrescribed *decompTarget =
		new DecompTargetNoCompPrescribed(_nxs,getNumberConstraints(),this);
...
//	printf("DecompHardUTWalkNoCompPrescribed.determineConstraints: NC = %d\n",
 ...
 */
int DecompHardUTWalkNoCompPrescribed::
getNumberConstraints()
{
	int i,nc;
	for(nc=i=0;i<4;i++) {
		...
		for(j=0;j<3;j++) {
			...
			if(whichC==0) {
				...
				*c = _bc[i].getPC(j)->evaluateC2(fsAcc);
				...
				printf("DecompHardUTWalkNoCompPrescribed.suComputeConstraint: ERROR- invalid C\n");
			}
