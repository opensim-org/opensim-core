...
template<> inline bool& Property_Deprecated::getValue() {
    return getValueBool();
}
template<> inline const bool& Property_Deprecated::getValue() const {
    return getValueBool();
}
template<> inline int& Property_Deprecated::getValue() {
    return getValueInt();
}
template<> inline const int& Property_Deprecated::getValue() const {
    return getValueInt();
}
template<> inline double& Property_Deprecated::getValue() {
    return getValueDbl();
}
template<> inline const double& Property_Deprecated::getValue() const {
    return getValueDbl();
}
template<> inline std::string& Property_Deprecated::getValue() {
    return getValueStr();
}
template<> inline const std::string& Property_Deprecated::getValue() const {
    return getValueStr();
}

template<> inline Array<bool>& Property_Deprecated::getValue() {
    return getValueBoolArray();
}
template<> inline const Array<bool>& Property_Deprecated::getValue() const {
    return getValueBoolArray();
}
template<> inline Array<int>& Property_Deprecated::getValue() {
    return getValueIntArray();
}
template<> inline const Array<int>& Property_Deprecated::getValue() const {
    return getValueIntArray();
}
template<> inline Array<double>& Property_Deprecated::getValue() {
    return getValueDblArray();
}
template<> inline const Array<double>& Property_Deprecated::getValue() const {
    return getValueDblArray();
}
template<> inline Array<std::string>& Property_Deprecated::getValue() {
    return getValueStrArray();
}
template<> inline const Array<std::string>& Property_Deprecated::getValue() const {
    return getValueStrArray();
}

template<> inline Array<bool>& Property_Deprecated::getValueArray() {
    return getValueBoolArray();
}
template<> inline const Array<bool>& Property_Deprecated::getValueArray() const {
    return getValueBoolArray();
}
template<> inline Array<int>& Property_Deprecated::getValueArray() {
    return getValueIntArray();
}
template<> inline const Array<int>& Property_Deprecated::getValueArray() const {
    return getValueIntArray();
}
template<> inline Array<double>& Property_Deprecated::getValueArray() {
    return getValueDblArray();
}
template<> inline const Array<double>& Property_Deprecated::getValueArray() const {
    return getValueDblArray();
}
template<> inline Array<std::string>& Property_Deprecated::getValueArray() {
    return getValueStrArray();
}
template<> inline const Array<std::string>& Property_Deprecated::getValueArray() const {
    return getValueStrArray();
}
