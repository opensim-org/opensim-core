...
#define OpenSim_DECLARE_PROPERTY_INDEX_HELPER(name)                         \
    PropertyIndex PropertyIndex_##name;

#define OpenSim_DECLARE_PROPERTY_INDEX_HELPER_DEFAULT(name, T, comment,     \
        defaultValue)                                                       \
    PropertyIndex PropertyIndex_##name =                                    \
        addProperty<T>(#name,comment,defaultValue);
...
#define OpenSim_DECLARE_LIST_PROPERTY_INDEX_HELPER_DEFAULT(name, T,         \
        comment, minSize, maxSize, defaultValue)                            \
    PropertyIndex PropertyIndex_##name = addListProperty<T>(#name, comment, \
                            minSize, maxSize, defaultValue);
...
#define OpenSim_DECLARE_PROPERTY(name, T, comment)                          \
    OpenSim_DECLARE_PROPERTY_INDEX_HELPER(name)                             \
    OpenSim_DECLARE_PROPERTY_HELPER(name,T)                                 \
...
#define OpenSim_DECLARE_PROPERTY_DEFAULT(name, T, comment, defaultValue)    \
    OpenSim_DECLARE_PROPERTY_INDEX_HELPER_DEFAULT(name,T,comment,           \
            defaultValue)                                                   \
    OpenSim_DECLARE_PROPERTY_HELPER(name,T)                                 \
    void constructProperty_##name(const T& initValue)                       \
    {   PropertyIndex_##name = addProperty<T>(#name,comment,initValue); }   \
...
#define OpenSim_DECLARE_UNNAMED_PROPERTY(T, comment)                        \
    OpenSim_DECLARE_PROPERTY_INDEX_HELPER(T)                                \
