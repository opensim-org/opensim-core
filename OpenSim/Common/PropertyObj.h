...
public:
    ...
    //--------------------------------------------------------------------------
public:
    virtual bool isValidObject(const Object *obj) const override { return true; } // TODO: make this class templated and do type checking
    // TYPE
    ...
    virtual Object& getValueObj() override;
    virtual const Object& getValueObj() const override;
    // VALUE as String
