...
public:
    ...
    // VALUE
    virtual void setValue(const Array<std::string> &aArray) override;
    virtual void setValue(int aSize,const std::string aArray[]) override;
    virtual Array<std::string>& getValueStrArray() override;
    virtual const Array<std::string>& getValueStrArray() const override;
