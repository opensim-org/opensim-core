...
public:
    ...
    // VALUE
    virtual void setValue(const Array<bool> &aArray) override;
    virtual void setValue(int aSize,const bool aArray[]) override;
    virtual Array<bool>& getValueBoolArray() override;
    virtual const Array<bool>& getValueBoolArray() const override;
    // SIZE
