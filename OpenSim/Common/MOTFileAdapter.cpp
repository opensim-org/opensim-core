...
const std::string MOTFileAdapter::_timeColumnLabel{"time"};
...
MOTFileAdapter::extendRead(const std::string& fileName) const {
...
void
MOTFileAdapter::extendWrite(const InputTables& absTables, 
                            const std::string& fileName) const {
