#ifndef _OPENSIM_COMAK_SETTINGS_SET_H_
#define  _OPENSIM_COMAK_SETTINGS_SET_H_
/* -------------------------------------------------------------------------- *
 *                         OpenSim:  COMAKSettingsSet.h                       *
 * -------------------------------------------------------------------------- *
...
namespace OpenSim {
    ...
    OpenSim_DECLARE_CONCRETE_OBJECT(
        COMAKSecondaryCoordinateSet, Set<COMAKSecondaryCoordinate>);
...
#endif //  _OPENSIM_COMAK_SETTINGS_SET_H_
