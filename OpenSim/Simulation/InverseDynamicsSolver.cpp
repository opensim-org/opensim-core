...
Vector InverseDynamicsSolver::solve(
        const SimTK::State& s, const SimTK::Vector& udot) {
    ...
    const Vector& appliedMobilityForces =
            getModel().getMultibodySystem().getMobilityForces(
    ...
    const SimTK::Vector_<SimTK::SpatialVec>& appliedBodyForces =
            getModel().getMultibodySystem().getRigidBodyForces(
                    s, SimTK::Stage::Dynamics);
