/* -------------------------------------------------------------------------- *
 *              OpenSim:  MuscleMetabolicsBhargava2004Probe.cpp               *
 * -------------------------------------------------------------------------- *
...
//=============================================================================
#include "MuscleMetabolicsBhargava2004Probe.h"
 ...
 * Default constructor.
 */
MuscleMetabolicsBhargava2004Probe::MuscleMetabolicsBhargava2004Probe() : Probe()
{
    setNull();
    constructProperties();
}
 ...
 */
MuscleMetabolicsBhargava2004Probe::MuscleMetabolicsBhargava2004Probe(
...
//_____________________________________________________________________________
/**
 * Set the data members of this MuscleMetabolicsBhargava2004Probe to their null values.
 */
void MuscleMetabolicsBhargava2004Probe::setNull()
{
	setAuthors("Tim Dorn");
 ...
 */
void MuscleMetabolicsBhargava2004Probe::constructProperties()
{
    ...
    constructProperty_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet
 ...
 *
 * @param aModel OpenSim model containing this MuscleMetabolicsBhargava2004Probe.
 */
void MuscleMetabolicsBhargava2004Probe::connectToModel(Model& aModel)
{
    Super::connectToModel(aModel);

    const int nM = 
        get_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet()
        .getSize();
    for (int i=0; i<nM; ++i) {
        connectIndividualMetabolicMuscle(aModel, 
            upd_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet()[i]);
    }
}
 ...
 *
 */
void MuscleMetabolicsBhargava2004Probe::connectIndividualMetabolicMuscle(
    Model& aModel, 
    MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter& mm)
{
    ...
    if( k < 0 )	{
        cout << "WARNING: MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter: "
 ...
 */
SimTK::Vector MuscleMetabolicsBhargava2004Probe::
computeProbeInputs(const State& s) const
{
    ...
    for (int i=0; i<nM; i++)
    {
        ...
        MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter& mm = 
            get_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet()[i];   
 ...
 */
int MuscleMetabolicsBhargava2004Probe::getNumProbeInputs() const
{
    return 1;
}
 ...
 */
Array<string> MuscleMetabolicsBhargava2004Probe::getProbeOutputLabels() const 
{
    Array<string> labels;
...
*/
const int MuscleMetabolicsBhargava2004Probe::
	getNumMetabolicMuscles() const  
{ 
	return get_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet()
        .getSize(); 
}
 ...
 * metabolic analysis.
 */
void MuscleMetabolicsBhargava2004Probe::
...
{
    MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter* mm = 
        new MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter(
            muscleName,
    ...
    upd_MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameterSet()
 ...
 */
bool MuscleMetabolicsBhargava2004Probe::
 ...
 */
const double MuscleMetabolicsBhargava2004Probe::
...
const MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter* 
    MuscleMetabolicsBhargava2004Probe::getMetabolicParameters(
...
MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter* 
    MuscleMetabolicsBhargava2004Probe::updMetabolicParameters(
...
// Set muscle mass
//--------------------------------------------------------------------------
void MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter::
setMuscleMass()    
{ 
...
// Object interface
//--------------------------------------------------------------------------
void MuscleMetabolicsBhargava2004Probe_MetabolicMuscleParameter::setNull()
{
	setAuthors("Tim Dorn");
