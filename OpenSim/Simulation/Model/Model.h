...
//==============================================================================
    ...
    OpenSim_DECLARE_PROPERTY_USERINIT(ground, Ground,
        "The model's ground reference frame.", Ground());

    OpenSim_DECLARE_PROPERTY_USERINIT(gravity,SimTK::Vec3,
        "Acceleration due to gravity, expressed in ground.",
        SimTK::Vec3(0.0, -9.80665, 0.0));

    OpenSim_DECLARE_PROPERTY_USERINIT(credits,std::string,
        "Credits (e.g., model author names) associated with the model.",
        "Frank Anderson, Peter Loan, Ayman Habib, Ajay Seth, Michael Sherman");

    OpenSim_DECLARE_PROPERTY_USERINIT(publications,std::string,
        "Publications and references associated with the model.",
        "List of publications related to model...");

    OpenSim_DECLARE_PROPERTY_USERINIT(length_units, std::string,
        "Units for all lengths.", "meters");

    OpenSim_DECLARE_PROPERTY_USERINIT(force_units, std::string,
    ...
    OpenSim_DECLARE_PROPERTY_USERINIT(assembly_accuracy, double,
