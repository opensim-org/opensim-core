...
TEST_CASE("testCoordinateLinearStopForce") {
    ...
    double lowerLimit = 0.1;
    double upperLimit = 2.0;
    auto* stopForce = new CoordinateLinearStopForce("height",
    ...
    SECTION("Invalid coordinate name") {
        stopForce->set_coordinate("nonexistent_coord");
        REQUIRE_THROWS_AS(model.initSystem(), OpenSim::Exception);
    }
