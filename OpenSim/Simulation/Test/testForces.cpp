...
int main()
{
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testPathSpring");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testExternalForce");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testP2PSpringMass");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testBushingForce");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testElasticFoundation");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testHuntCrossleyForce");
    }
    ...
    try {
        ...
        cout << e.what() <<endl;
        failures.push_back("testCoordinateLimitForce");
    }
    ...
    try {
        testExpressionBasedPointToPointForce();
    }
    catch (const std::exception& e) {
        cout << e.what() <<endl;
    ...
    try {
        testExpressionBasedCoordinateForce();
    }
    catch (const std::exception& e) {
        cout << e.what() <<endl;
