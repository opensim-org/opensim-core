...
namespace {
    ...
    //                               UMBERGER MUSCLE
    //==========================================================================
    // Muscle model used by Umberger et al., which is a slightly modified
    // version of the contractile element described by van Soest and Bobbert.
                                    ...
                                    double* totalEnergyRate)
    {
        ...
        // Create block. The length and velocity of the muscle will be specified,
        // so the properties of the block are irrelevant.
        ...
        SliderJoint* prismatic = new SliderJoint("prismatic", ground, Vec3(0),
                                                 Vec3(0), *block, Vec3(0), Vec3(0));
    ...
    // attaches several Umberger2010 and Bhargava2004 muscle metabolics probes,
    // and confirms that the probes are functioning properly:
