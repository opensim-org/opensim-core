    ...
    SimTK::Array_<SimTK::DecorativeGeometry>&   appendToThis) const
{
    ...
    const SimTK::Vec3& p_B1 = frame1.getTransformInGround(state)*get_location_body_1();
    const OpenSim::PhysicalFrame& frame2 = getBody2();
    const SimTK::Vec3& p_B2 = frame2.getTransformInGround(state)*get_location_body_2();
