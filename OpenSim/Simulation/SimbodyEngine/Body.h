...
public:
    ...
    const SimTK::Vec3& getMassCenter() const {
        return get_mass_center();
    }
    void setMassCenter(const SimTK::Vec3& com) {
        return set_mass_center(com);
    }
    ...
    const VisibleObject* getDisplayer() const {
        return &get_VisibleObject();
    }
    VisibleObject* updDisplayer() {
        return &upd_VisibleObject();
    }

    const SimTK::MobilizedBodyIndex getIndex() const {
        return _index;
    };
