...
public:
    ...
    bool getActiveUseDefault() const {
        return _activeProp.getValueIsDefault();
    }
    const char* getQuadrantName() const {
        return _quadrantName.c_str();
    }
    bool getQuadrantNameUseDefault() const {
        return _quadrantNameProp.getValueIsDefault();
    }
