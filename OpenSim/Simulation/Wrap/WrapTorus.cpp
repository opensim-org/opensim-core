 ...
 */
static void calcCircleResids(int numResid,
                             int numQs,
                             double q[],
                             double resid[],
                             int *flag2,
 ...
 */
static int findClosestPoint(double radius,
                            SimTK::Vec3 p1,
                            SimTK::Vec3 p2,
                            double* xc,
                            double* yc,
 ...
 */
WrapObject::WrapAction WrapTorus::wrapLine(
        const SimTK::State& s,
        ...
        bool& aFlag) const
{
    ...
    if (findClosestPoint(get_outer_radius(),
                         aPoint1,
                         aPoint2,
                         &closestPt[0],
                         &closestPt[1],
...
void WrapTorus::generateDecorations(
        bool fixed,
