...
void WrapCylinderObst::connectToModelAndBody(Model& aModel, OpenSim::Body& aBody)
{
    ...
    if (_wrapDirectionName == "righthand" || _wrapDirectionName == "right" || _wrapDirectionName == "righthanded" || _wrapDirectionName == "Righthand" || _wrapDirectionName == "Right" || _wrapDirectionName == "Righthanded")
        _wrapDirection = righthand;
    else if (_wrapDirectionName == "lefthand"  || _wrapDirectionName == "left"  || _wrapDirectionName == "lefthanded"  || _wrapDirectionName == "Lefthand"  || _wrapDirectionName == "Left"  || _wrapDirectionName == "Lefthanded")
        _wrapDirection = lefthand;
    else if (_wrapDirectionName == "Unassigned") // wrapDirection was not specified in obstacle object definition; use default
    {
        _wrapDirection = righthand;
        _wrapDirectionName = "righthand";
    }
...
{
    SimTK::Vec3& aPointP = aPoint1;
    double R=0.8*( _wrapDirection==righthand ? _radius : -_radius );
    SimTK::Vec3& aPointS = aPoint2;
    double Qx,Qy,Qz, Tx,Ty,Tz;
