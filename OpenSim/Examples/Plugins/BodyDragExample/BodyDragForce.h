...
class OSIMPLUGIN_API BodyDragForce : public ForceProducer
{
...
private:
    /**
     * Implements the `ForceProducer` API by computing the bushing force and emitting it
     ...
     *
     * This `BodyDragForce` implementation is based on `SimTK::Force::LinearBushing`,
     * which was developed by Michael Sherman.
     */
