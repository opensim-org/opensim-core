...
//      joint; see buildHopperModel.cpp and Component::dumpOutputInfo().
// [Step 1, Task A]
...
//      and Component::dumpSubcomponentInfo().
// [Step 3, Task A]
...
void run(bool showVisualizer, bool simulateOnce)
{
    ...
    if (true)
    {
        ...
        hopper.dumpSubcomponentInfo(); // TODO use everywhere.
        // Show only the Joints in the model.
        hopper.dumpSubcomponentInfo<Joint>();
