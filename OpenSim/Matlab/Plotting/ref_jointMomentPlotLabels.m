...
qPlotLabel{3}  = {};
qPlotLabel{4}  = {};
qPlotLabel{5}  = {'pelvis_tx_ik_moment', 'pelvis_tx_rra1_moment', 'pelvis_tx_rra2_moment', 'pelvis_tx_cmc_moment'};
qPlotLabel{6}  = {'pelvis_list_ik_moment', 'pelvis_list_rra1_moment', 'pelvis_list_rra2_moment', 'pelvis_list_cmc_moment'};
qPlotLabel{7}  = {'pelvis_ty_ik_moment', 'pelvis_ty_rra1_moment', 'pelvis_ty_rra2_moment', 'pelvis_ty_cmc_moment'};
qPlotLabel{8}  = {'pelvis_rotation_ik_moment', 'pelvis_rotation_rra1_moment', 'pelvis_rotation_rra2_moment', 'pelvis_rotation_cmc_moment'};
qPlotLabel{9}  = {'pelvis_tz_ik_moment', 'pelvis_tz_rra1_moment', 'pelvis_tz_rra2_moment', 'pelvis_tz_cmc_moment'};
qPlotLabel{10} = {'pelvis_tilt_ik_moment', 'pelvis_tilt_rra1_moment', 'pelvis_tilt_rra2_moment', 'pelvis_tilt_cmc_moment'};
subplotTitle{1}  = {'Left'};
...
qPlotLabel{3}  = {};
qPlotLabel{4}  = {};
qPlotLabel{5}  = {'hip_flexion_l_ik_moment', 'hip_flexion_l_rra1_moment', 'hip_flexion_l_rra2_moment', 'hip_flexion_l_cmc_moment'};
qPlotLabel{6}  = {'hip_flexion_r_ik_moment', 'hip_flexion_r_rra1_moment', 'hip_flexion_r_rra2_moment', 'hip_flexion_r_cmc_moment'};
qPlotLabel{7}  = {'hip_adduction_l_ik_moment', 'hip_adduction_l_rra1_moment', 'hip_adduction_l_rra2_moment', 'hip_adduction_l_cmc_moment'};
qPlotLabel{8}  = {'hip_adduction_r_ik_moment', 'hip_adduction_r_rra1_moment', 'hip_adduction_r_rra2_moment', 'hip_adduction_r_cmc_moment'};
qPlotLabel{9}  = {'hip_rotation_l_ik_moment', 'hip_rotation_l_rra1_moment', 'hip_rotation_l_rra2_moment', 'hip_rotation_l_cmc_moment'};
qPlotLabel{10} = {'hip_rotation_r_ik_moment', 'hip_rotation_r_rra1_moment', 'hip_rotation_r_rra2_moment', 'hip_rotation_r_cmc_moment'};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
subplotTitle{4}  = {};
...
qPlotLabel{3}  = {};
qPlotLabel{4}  = {};
qPlotLabel{5}  = {'knee_angle_l_ik_moment', 'knee_angle_l_rra1_moment', 'knee_angle_l_rra2_moment', 'knee_angle_l_cmc_moment'};
qPlotLabel{6}  = {'knee_angle_r_ik_moment', 'knee_angle_r_rra1_moment', 'knee_angle_r_rra2_moment', 'knee_angle_r_cmc_moment'};
qPlotLabel{7}  = {'ankle_angle_l_ik_moment', 'ankle_angle_l_rra1_moment', 'ankle_angle_l_rra2_moment', 'ankle_angle_l_cmc_moment'};
qPlotLabel{8}  = {'ankle_angle_r_ik_moment', 'ankle_angle_r_rra1_moment', 'ankle_angle_r_rra2_moment', 'ankle_angle_r_cmc_moment'};
qPlotLabel{9}  = {};
qPlotLabel{10} = {};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
...
subplotRange{3}  = {};
subplotRange{4}  = {};
subplotRange{5}  = [-40 20];
subplotRange{6}  = [-40 20];
...
subplotTick{3}  = {};
subplotTick{4}  = {};
subplotTick{5}  = -40:20:20;
subplotTick{6}  = -40:20:20;
subplotTick{7}  = {};
subplotTick{8}  = {};
subplotTick{9}  = {};
subplotTick{10} = {};
...
qPlotLabel{3}  = {};
qPlotLabel{4}  = {};
qPlotLabel{5}  = {'lumbar_extension_ik_moment', 'lumbar_extension_rra1_moment', 'lumbar_extension_rra2_moment', 'lumbar_extension_cmc_moment'};
qPlotLabel{6}  = {};
qPlotLabel{7}  = {'lumbar_bending_ik_moment', 'lumbar_bending_rra1_moment', 'lumbar_bending_rra2_moment', 'lumbar_bending_cmc_moment'};
qPlotLabel{8}  = {};
qPlotLabel{9}  = {'lumbar_rotation_ik_moment', 'lumbar_rotation_rra1_moment', 'lumbar_rotation_rra2_moment', 'lumbar_rotation_cmc_moment'};
qPlotLabel{10} = {};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
