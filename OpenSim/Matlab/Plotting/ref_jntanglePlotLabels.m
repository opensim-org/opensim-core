function figContents = ref_jntanglePlotLabels()
...
gcdMeanLabel{5}  = {};
gcdMeanLabel{6}  = {};
gcdMeanLabel{7}  = 'PelvicObliquity';
gcdMeanLabel{8}  = 'PelvicTilt';
gcdMeanLabel{9}  = 'PelvicRotation';
gcdMeanLabel{10} = {};
gcdMeanLabel{11} = {};
gcdMeanLabel{12} = {};
...
qMeasuredLabel{11} = {};
qMeasuredLabel{12} = {};
gcdMeanLabel{1}  = 'HipAbAdduct';
gcdMeanLabel{2}  = 'HipFlexExt';
gcdMeanLabel{3}  = 'HipRotation';
gcdMeanLabel{4}  = {};
gcdMeanLabel{5}  = 'KneeFlexExt';
gcdMeanLabel{6}  = {};
gcdMeanLabel{7}  = {};
gcdMeanLabel{8}  = 'DorsiPlanFlex';
gcdMeanLabel{9}  = {};
gcdMeanLabel{10} = {};
gcdMeanLabel{11} = {};
gcdMeanLabel{12} = {};
...
subplotRange{1} = [-15 10];
%subplotRange{2}  = [-25 75];
subplotRange{2} = [-40 60];
...
figContents(2).gcdMeanLabel = gcdMeanLabel;
...
figContents(3).gcdMeanLabel = gcdMeanLabel;
