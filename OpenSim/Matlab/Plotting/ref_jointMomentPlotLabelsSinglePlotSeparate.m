function figContents = ref_jointMomentPlotLabelsSinglePlotSeparate()
...
figContents(2).subplotRange{1}  = [-65 105];
figContents(3).subplotRange{1}  = {};
figContents(4).subplotRange{1}  = [-40 40];
figContents(5).subplotRange{1}  = {};
figContents(6).subplotRange{1}  = [-115 110];
figContents(1).subplotTick{1}  = {};
figContents(2).subplotTick{1}  = -50:50:100;
figContents(3).subplotTick{1}  = {};
figContents(4).subplotTick{1}  = -40:40:40;
figContents(5).subplotTick{1}  = {};
figContents(6).subplotTick{1}  = -100:100:100;
...
figContents(7).subplotRange{1} = [-200 110];
figContents(8).subplotRange{1} = [-200 110];
figContents(9).subplotRange{1}  = [-90 70];
figContents(10).subplotRange{1} = [-90 70];
figContents(11).subplotRange{1}  = [-25 50];
figContents(12).subplotRange{1} = [-25 50];
figContents(7).subplotTick{1} = -200:100:100;
figContents(8).subplotTick{1} = -200:100:100;
figContents(9).subplotTick{1}  = -70:70:70;
figContents(10).subplotTick{1} = -70:70:70;
figContents(11).subplotTick{1}  = -25:25:50;
figContents(12).subplotTick{1} = -25:25:50;
...
figContents(13).subplotRange{1} = [-100 160];
figContents(14).subplotRange{1} = [-100 160];
figContents(15).subplotRange{1} = [-150 50];
figContents(16).subplotRange{1} = [-150 50];
figContents(13).subplotTick{1} = -100:100:100;
figContents(14).subplotTick{1} = -100:100:100;
figContents(15).subplotTick{1} = -150:50:50;
figContents(16).subplotTick{1} = -150:50:50;
...
figContents(17).subplotRange{1} = [-30 65];
figContents(18).subplotRange{1} = [-45 40];
figContents(19).subplotRange{1} = [-10 12];
figContents(17).subplotTick{1} = -30:30:60;
figContents(18).subplotTick{1} = -40:40:40;
figContents(19).subplotTick{1} = -10:10:10;

% Repeat all of the above (which was for fast walking) for free-speed
% walking.
for i = 20:38
    figContents(i) = figContents(i - 19);
end

% Repeat all of the above (which was for fast walking) for slow
% walking.
for i = 39:57
    figContents(i) = figContents(i - 38);
end
