function figContents = ref_muscleActPlotLabelsDelaware()
...
muscleActivationPlotIndices = {5, 5, 7;
                               6, 6, 8};
muscleNumbersInPlot = {1, 2, 1};
subplotTitle{1}  = {'Left'};
...
figContents(1).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(1).muscleNumbersInPlot = muscleNumbersInPlot;
...
clear qPlotLabel qMeasuredLabel perryAbbr muscleActivationPlotIndices muscleNumbersInPlot; 
...
muscleActivationPlotIndices = {5, 7, 9;
                               6, 8, 10};
muscleNumbersInPlot = {1, 1, 1};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
subplotTitle{4}  = {};
...
figContents(2).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(2).muscleNumbersInPlot = muscleNumbersInPlot;
...
muscleActivationPlotIndices = {7, 7, 7, 9;
                               8, 8, 8, 10};
muscleNumbersInPlot = {1, 2, 3, 1};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
subplotTitle{4}  = {};
...
figContents(3).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(3).muscleNumbersInPlot = muscleNumbersInPlot;
...
muscleActivationPlotIndices = {5, 5, 7, 9;
                               6, 6, 8, 10};
muscleNumbersInPlot = {1, 2, 1, 1};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
subplotTitle{4}  = {};
...
figContents(4).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(4).muscleNumbersInPlot = muscleNumbersInPlot;
...
figContents(5).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(5).muscleNumbersInPlot = muscleNumbersInPlot;
...
figContents(6).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(6).muscleNumbersInPlot = muscleNumbersInPlot;
...
muscleActivationPlotIndices = {5, 7, 7, 9, 9;
                               6, 8, 8, 10, 10};
muscleNumbersInPlot = {1, 1, 2, 1, 2};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
subplotTitle{3}  = {};
subplotTitle{4}  = {};
...
figContents(7).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(7).muscleNumbersInPlot = muscleNumbersInPlot;
...
muscleActivationPlotIndices = {5, 7, 5, 9, 9;
                               6, 8, 6, 10, 10};
muscleNumbersInPlot = {1, 1, 2, 1, 2};
subplotTitle{1}  = {'Left'};
subplotTitle{2}  = {'Right'};
...
figContents(8).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(8).muscleNumbersInPlot = muscleNumbersInPlot;
...
figContents(9).muscleActivationPlotIndices = muscleActivationPlotIndices;
figContents(9).muscleNumbersInPlot = muscleNumbersInPlot;
