function evaluateSimulationOnCombinedPages()
...
gencoordColumnLabels = { 'pelvis_tx' 'pelvis_list' 'pelvis_ty' ...
    'pelvis_rotation' 'pelvis_tz' 'pelvis_tilt' 'hip_flexion_l' ...
...
if plotJointMoments
    ...
    for i = figNum : figNum + length( jointMomentColumnLabels ) - 1
        ...
        plotSettings.literatureMomentCurveColors = { 'g' 'b' 'c' 'r' 'm' };
