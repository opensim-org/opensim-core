function R = get_trunkCSfromSternumC7(landmarks)
% Purpose:  Returns the rotation matrix that defines the orientation 
%           of a trunk reference frame from the coordinates of C7, 
%           sternum, and subclavicular markers.
%
...
% Y axis (SI, S+) is the unit vector Z x (sternalnotch - neck).
  Yaxis = cross(Zaxis, (landmarks.sternalnotch - landmarks.neck));
