...
//=============================================================================
//#include "WrapTata.h"
#include "OpenSim/Wraps/WrapTata.h"
//#include "PathWrap.h"
...
* Copy constructor.
*
* @param aWrapTata WrapTata to be copied.
*/
WrapTata::WrapTata(const WrapTata& aWrapTata)// :
//   WrapObject(aWrapTata)
{
    setNull();
    setupProperties();
    copyData(aWrapTata);
...
//_____________________________________________________________________________
/**
* Set the data members of this WrapTata to their null values.
*/
void WrapTata::setNull()
{
}
...
*/
void WrapTata::setupProperties()
{
    // BASE CLASS
    //WrapObject::setupProperties();

    SimTK::Vec3 defaultDimensions = {-1.0, -1.0, -1.0};
    constructProperty_coucou(defaultDimensions);
...
* @param aModel
*/
void WrapTata::connectToModelAndBody(Model& aModel, PhysicalFrame& aBody)
{
    // Base class
    ...
    {
        string errorMessage = "Error: dimensions for WrapTata " + getName() + " were either not specified, or are negative.";
...
void WrapTata::extendScale(const SimTK::State& s, const ScaleSet& scaleSet)
{
...
//_____________________________________________________________________________
/**
* Copy data members from one WrapTata to another.
*
* @param aWrapTata WrapTata to be copied.
*/
void WrapTata::copyData(const WrapTata& aWrapTata)
{
    set_dimensions(aWrapTata.get_dimensions());
}
 ...
 */
const char* WrapTata::getWrapTypeName() const
{
    return wrapTypeName;
}
 ...
 */
string WrapTata::getDimensionsString() const
{
 ...
 */
SimTK::Vec3 WrapTata::getRadii() const
{
...
//*/
//WrapTata& WrapTata::operator=(const WrapTata& aWrapTata)
//{
//    // BASE CLASS
//    WrapObject::operator=(aWrapTata);
 ...
 */
int WrapTata::wrapLine(const SimTK::State& s, SimTK::Vec3& aPoint1, SimTK::Vec3& aPoint2,
 ...
 */
int WrapTata::calcTangentPoint(double p1e, SimTK::Vec3& r1, SimTK::Vec3& p1, SimTK::Vec3& m,
 ...
 */
void WrapTata::CalcDistanceOnEllipsoid(SimTK::Vec3& r1, SimTK::Vec3& r2, SimTK::Vec3& m, SimTK::Vec3& a,
 ...
 */
double WrapTata::findClosestPoint(double a, double b, double c,
 ...
 */
double WrapTata::closestPointToEllipse(double a, double b, double u,
...
// Implement generateDecorations by WrapTata to replace the previous out of place implementation
// in ModelVisualizer
void WrapTata::generateDecorations(bool fixed, const ModelDisplayHints& hints, const SimTK::State& state,
