#ifndef __WrapTata_h__
#define __WrapTata_h__
/* -------------------------------------------------------------------------- *
 *                         OpenSim:  WrapTata.h                          *
 * -------------------------------------------------------------------------- *
...
//=============================================================================
/**
 * A class implementing an WrapTata for muscle wrapping.
 *
 * @author Peter Loan
 * @version 1.0
 */
class OSIMSIMULATION_API WrapTata : public WrapObject {
OpenSim_DECLARE_CONCRETE_OBJECT(WrapTata, WrapObject);
...
//=============================================================================
    ...
    //--------------------------------------------------------------------------
public:
    OpenSim_DECLARE_PROPERTY(coucou, SimTK::Vec3, "Coucouter")
    OpenSim_DECLARE_PROPERTY(dimensions, SimTK::Vec3, "Dimensions")

    WrapTata();
    WrapTata(const WrapTata& aWrapTata);
    virtual ~WrapTata();

//#ifndef SWIG
//    WrapTata& operator=(const WrapTata& aWrapTata);
//#endif
    void copyData(const WrapTata& aWrapTata);
    const char* getWrapTypeName() const override;
    std::string getDimensionsString() const override;
        SimTK::Vec3 getRadii() const;

    /** Scale the WrapTata's dimensions. The base class (WrapObject) scales the
        origin of the WrapTata in the body's reference frame. */
...
//=============================================================================
};  // END of class WrapTata
//=============================================================================
//=============================================================================

} // end of namespace OpenSim

#endif // __WrapTata_h__
