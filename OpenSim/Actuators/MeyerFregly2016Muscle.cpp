...
const std::string MeyerFregly2016Muscle::STATE_NORMALIZED_TENDON_FORCE_NAME(
        "normalized_tendon_force");
const std::string
        MeyerFregly2016Muscle::DERIVATIVE_NORMALIZED_TENDON_FORCE_NAME(
                "implicitderiv_normalized_tendon_force");
const std::string
        MeyerFregly2016Muscle::RESIDUAL_NORMALIZED_TENDON_FORCE_NAME(
...
constexpr double MeyerFregly2016Muscle::m_minNormTendonForce;
constexpr double MeyerFregly2016Muscle::m_maxNormTendonForce;
...
void MeyerFregly2016Muscle::computeInitialFiberEquilibrium(
        SimTK::State& s) const {
    ...
    //        printf("\n\nMeyerFregly2016Muscle static solution:"
...
// std::pair<MeyerFregly2016Muscle::StatusFromEstimateMuscleFiberState,
//        MeyerFregly2016Muscle::ValuesFromEstimateMuscleFiberState>
// MeyerFregly2016Muscle::estimateMuscleFiberState(const double activation,
