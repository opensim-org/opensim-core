...
//==============================================================================
    ...
    /** This function computes the fiber length such that fiber and tendon are
    developing the same force, and the velocity of the entire musculotendon
...
private:
    ...
    /*  @param total force developed by the fiber
        @param cosphi the cosine of the pennation angle
        @returns the force generated by the fiber, in the direction of the
    tendon */
