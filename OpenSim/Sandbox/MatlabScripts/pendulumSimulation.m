...
for iCoordinate = 0 : model.getCoordinateSet.getSize - 1
        model.getCoordinateSet.get(iCoordinate).setDefaultValue(default_coordinates(iCoordinate+1))
end
