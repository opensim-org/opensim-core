...
%% This API example demonstrates building a simple arm model consisting of
% two bodies, two joints, a muscle and a controller. 

% Author: James Dunne, Chris Dembia, Tom Uchida, Neil Dhir,  
% Shrinidhi K. Lakshmikanth, Ajay Seth, Ayman Habib, Jen Hicks,   
...
% Set the color Grey
bodyGeometry.setColor( Vec3(.5,.5,.5) );
