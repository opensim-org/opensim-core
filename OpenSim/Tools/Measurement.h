...
public:
    ...
    BodyScaleSet &getBodyScaleSet() {
        return _bodyScaleSet;
    }

    MarkerPairSet& getMarkerPairSet() {
        return _markerPairSet;
    }
    int getNumMarkerPairs() const {
        return _markerPairSet.getSize();
    }
    const MarkerPair& getMarkerPair(int aIndex) const {
        return _markerPairSet[aIndex];
    }
