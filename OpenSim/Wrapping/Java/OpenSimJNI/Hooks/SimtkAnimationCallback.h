...
public:
    ...
    Model *getModelForDisplay() {
        return _modelForDisplay;
    }
    void setModelForDisplaySetConfiguration(bool aSetConfiguration) {
        _modelForDisplaySetConfiguration = aSetConfiguration;
    }
    bool getModelForDisplayCompatibleStates() {
        return _modelForDisplayCompatibleStates;
    }
public:
