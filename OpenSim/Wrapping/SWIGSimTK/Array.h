...
// These provide direct access to the data members for our trusted friends.
    ...
    void setAllocated(size_type n)  {
        nAllocated = packed_size_type(n);
    }
...
//------------------------------------------------------------------------------
    ...
    @par Complexity:
        Constant time. **/
    T& at(index_type i) {
        return const_cast<T&>(this->CBase::at(i));
    }
    ...
    @par Complexity:
        Constant time. **/
    T& front() {
        return const_cast<T&>(this->CBase::front());
    }
    ...
    @par Complexity:
        Constant time. **/
    T& back() {
        return const_cast<T&>(this->CBase::back());
    }
...
//------------------------------------------------------------------------------
    ...
    an empty array. **/
    T* begin() {
        return const_cast<T*>(this->CBase::cbegin());
    }
    ...
    empty array. **/
    T* end() {
        return const_cast<T*>(this->CBase::cend());
    }
#ifndef SWIG
    /** Return a const reverse iterator pointing to the last element in the array
    or crend() if the array is empty. **/
    ...
    @note This method is from the proposed C++0x std::vector. **/
    T* data() {
        return const_cast<T*>(this->CBase::cdata());
    }
    /*@}    End of iterators. */
...
//------------------------------------------------------------------------------
    ...
    void swap(Array_& other) {
        ...
        other.setSize(nTmp);
        nTmp=allocated();
        setAllocated(other.allocated());
        other.setAllocated(nTmp);
    }
...
//------------------------------------------------------------------------------
    ...
    @par Complexity:
        Constant time. **/
    T& at(index_type i) {
        return const_cast<T&>(this->Base::at(i));
    }
    ...
    @par Complexity:
        Constant time. **/
    T& front() {
        return const_cast<T&>(this->Base::front());
    }
    ...
    @par Complexity:
        Constant time. **/
    T& back() {
        return const_cast<T&>(this->Base::back());
    }
#ifndef SWIG
...
// No constructors or destructors are called.
    ...
    {
        setData(allocN(n));    // size() left unchanged
        setAllocated(n);
    }
    void deallocateNoDestruct()
    {
        freeN(data());    // size() left unchanged
        setData(0);
        setAllocated(0);
    }
...
// copy construct one element from a given value
    static void copyConstruct(T* p, const T& v) {
        new(p) T(v);
    }
...
// These provide direct access to the data members.
    ...
    void setData(const T* p)        {
        this->CBase::setData(p);
    }
    void setSize(size_type n)       {
        this->CBase::setSize(n);
    }
    void incrSize()                 {
        this->CBase::incrSize();
    }
