...
//DecorativeGeometry& setUserRef(void* userRef);
    ...
    DecorativeGeometry& setScale(Real scale) {
        return setScaleFactors(Vec3(scale));
    }
...
public:
    ...
    DecorativePoint& setBodyId(int b)          {
        DecorativeGeometry::setBodyId(b);
        return *this;
    }
