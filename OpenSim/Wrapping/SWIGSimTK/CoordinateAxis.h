...
public:
    ...
    {
        sign = crossProductSign(axis2);
        return crossProductAxis(axis2);
    }
...
public:
    XCoordinateAxis() : CoordinateAxis(XTypeAxis()) {}
};
class CoordinateAxis::YCoordinateAxis : public CoordinateAxis {
public:
    YCoordinateAxis() : CoordinateAxis(YTypeAxis()) {}
};
class CoordinateAxis::ZCoordinateAxis : public CoordinateAxis {
public:
    ZCoordinateAxis() : CoordinateAxis(ZTypeAxis()) {}
};
...
public:
    ...
    CoordinateAxis crossProduct( const CoordinateDirection& dir2,
                                 int&                       sign ) const
    {
        sign = crossProductSign(dir2);
        return crossProductAxis(dir2);
    }
#ifndef SWIG
...
public:
    NegXDirection() : CoordinateDirection(XAxis,Negative()) {}
};
class CoordinateDirection::NegYDirection : public CoordinateDirection {
public:
    NegYDirection() : CoordinateDirection(YAxis,Negative()) {}
};
class CoordinateDirection::NegZDirection : public CoordinateDirection {
public:
    NegZDirection() : CoordinateDirection(ZAxis,Negative()) {}
};
